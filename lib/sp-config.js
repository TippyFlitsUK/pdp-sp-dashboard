...
// Map by lowercase address
const SP_BY_ADDRESS = new Map()
for (const sp of SP_LIST) {
  SP_BY_ADDRESS.set(sp.address.toLowerCase(), sp)
}
...
function getSPByAddress(addr) {
  return SP_BY_ADDRESS.get(addr.toLowerCase()) || null
}
...
module.exports = { getSP, getSPByAddress, getAllSPs, getTrackedSPs, SP_LIST }
